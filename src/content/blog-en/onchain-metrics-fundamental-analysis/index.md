...
Like MVRV, SOPR is better used as sentiment filter, not sole trigger. Combination with technical analysis (levels, volume, [RSI](https://felag.online/en/library/technical-analysis-rsi/)) gives more stable decisions.
...
More on tokenomics: [What is Tokenomics](https://felag.online/en/library/what-is-tokenomics/).
