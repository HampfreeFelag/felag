...
For most strategies, including the [ELDER 2.0 spot strategy](https://Felag-academy.org/en/library/spot-strategy-elder-20/), the following parameters are used:
- **%K Period:** 14
- **Slowing:** 3
- **%D Period:** 3
...
In the [ELDER 2.0](https://Felag-academy.org/en/library/spot-strategy-elder-20/) strategy, Stochastic works together with [Bollinger Bands](https://Felag-academy.org/en/library/bollinger-bands/) and the [Chande Momentum Oscillator (CMO)](https://Felag-academy.org/en/library/chande-momentum-oscillator/).
...
The oscillator tends to give false signals in strong trends. It is recommended to combine with trend filters — for example, [Bollinger Bands](https://Felag-academy.org/en/library/bollinger-bands/).

**How is Stochastic different from CMO?**

[CMO](https://Felag-academy.org/en/library/chande-momentum-oscillator/) measures pure momentum directly without double smoothing, while Stochastic compares the closing price to the High-Low range.

## Summary

Key indicators such as [Money Flow Index (MFI)](https://Felag-academy.org/en/library/money-flow-index/) and [Bollinger Bands](https://Felag-academy.org/en/library/bollinger-bands/) complement the analysis, providing a more complete market picture.
